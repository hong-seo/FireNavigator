...
try { // 시리얼 포트 연결 시도
  ...
  port.on('error', (err) => { // 시리얼 포트 에러 시 mock 데이터 사용
...
function generateMockData() {
  return [
    { node: 'Node1', gas: Math.random() * 1000, flame: Math.random() > 0.5 ? 1 : 0, temperature: 20 + Math.random() * 20, humidity: 50 + Math.random() * 50, isFire: Math.random() > 0.5 },
    { node: 'Node2', gas: Math.random() * 1000, flame: Math.random() > 0.5 ? 1 : 0, temperature: 20 + Math.random() * 20, humidity: 50 + Math.random() * 50, isFire: Math.random() > 0.5 },
    { node: 'Node3', gas: Math.random() * 1000, flame: Math.random() > 0.5 ? 1 : 0, temperature: 20 + Math.random() * 20, humidity: 50 + Math.random() * 50, isFire: Math.random() > 0.5 }
  ];
}
